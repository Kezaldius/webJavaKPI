...
public class ProductRequest {
    ...
    @Schema(description = "Price of the product. Must be strictly greater than 0", example = "99.99")
    @DecimalMin(value = "0.0", inclusive = false, message = "Price must be greater than 0")
    private double price;

    @Schema(description = "Detailed description of the cosmic product", example = "The finest dust from the Andromeda nebula")
